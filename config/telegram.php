...
return [
    ...
    |             ]
    |       - set webhook https://api.telegram.org/bot642536928:AAHf_xgEU2WADLofKidkdKIfmRZ_H5FULg4/setWebhook?url=https://7f6ab4fa.ngrok.io/642536928:AAHf_xgEU2WADLofKidkdKIfmRZ_H5FULg4/webhook
    |       - set webhook https://api.telegram.org/bot{my_bot_token}/setWebhook?url={url_to_send_updates_to}
    */
    
    'bots'                         => [
        'mybot' => [
            'username'            => 'absenskripsi',
            'token'               => '642536928:AAGAtYopCCBij_hW-2JoaXqbCPL8T5Zmpaw',
            // 'token'               => env('TELEGRAM_BOT_TOKEN', '642536928:AAHf_xgEU2WADLofKidkdKIfmRZ_H5FULg4'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            // 'webhook_url'         => 'https://e706daaa.ngrok.io/642536928:AAHf_xgEU2WADLofKidkdKIfmRZ_H5FULg4/webhook',
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
                //Acme\Project\Commands\MyTelegramBot\BotCommand::class
                // Vendor\Project\Commands\StartCommand::class,
                //App\Http\Commands\absenCommand::class,
                App\Bots\AbsenMasukCommand::class,
                App\Bots\AbsenKeluarCommand::class,
                App\Bots\DaftarCommand::class,
                App\Bots\AbsenCommand::class,
            ],
        ],
